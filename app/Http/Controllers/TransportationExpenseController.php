...
class TransportationExpenseController  extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'transportation_expenses.*.departure'  => 'required|string',
            'transportation_expenses.*.arrival'    => 'required|string',
            'transportation_expenses.*.route'      => 'required|string',
            'transportation_expenses.*.amount'     => 'required|numeric',
        ]);
