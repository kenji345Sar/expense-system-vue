...
<div class="max-w-5xl mx-auto py-8">
    ...
    <div class="mb-4">
        <a href="{{ route('transportation.create') }}" class="text-blue-600 hover:underline">＋ 新規申請</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="border-t">
                ...
                <td class="p-2 border space-x-2 text-center">
                    <a href="{{ route('transportation.edit', $expense->id) }}"
                        class="bg-blue-500 hover:bg-blue-700 text-white px-2 py-1 rounded text-sm">
                        編集
                    </a>
                    <form action="{{ route('transportation.submit', $expense->id) }}" method="POST"
                        class="inline-block"
    ...
    <div class="mt-6 space-y-2">
        <a href="{{ route('transportation.create') }}" class="text-blue-500 hover:underline">← 新規申請へ</a><br>
        <a href="{{ route('expenses.menu') }}" class="text-blue-500 hover:underline">← 経費メニューへ戻る</a>
    </div>
</div>
@endsection