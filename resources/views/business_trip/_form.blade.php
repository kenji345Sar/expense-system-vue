...
<div>
  ...
  <input type="date" name="business_trip_date" id="business_trip_date"
         value="{{ old('business_trip_date', $business_trip->business_trip_date ?? '') }}"
...
<div>
  ...
  <input type="text" name="departure" id="departure"
         value="{{ old('departure', $business_trip->departure ?? '') }}"
...
<div>
  ...
  <input type="text" name="destination" id="destination"
         value="{{ old('destination', $business_trip->destination ?? '') }}"
         class="w-full border rounded px-3 py-2" required>
</div>
...
<div>
  ...
  <input type="text" name="purpose" id="purpose"
         value="{{ old('purpose', $business_trip->purpose ?? '') }}"
         class="w-full border rounded px-3 py-2" required>
</div>
...
<div>
  ...
  <input type="number" name="amount" id="amount" step="0.01"
         value="{{ old('amount', $business_trip->amount ?? '') }}"
         class="w-full border rounded px-3 py-2" required>
</div>
